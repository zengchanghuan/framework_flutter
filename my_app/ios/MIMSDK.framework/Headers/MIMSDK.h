...
extern void callbackTrigerrr(NotificationListener listen);
extern void cb_proxy(void* v);
extern void cgoCall(void* p, int number);
...
extern char* GetVerifyCode(char* mobile);
...
extern char* GetConversationList(char* fromId);
